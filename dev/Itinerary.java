 ...
 * Incoming flights supply their dev.Itinerary in their flight descriptor, and the dev.ManagementRecord for the flight extracts the dev.Itinerary and holds it separately.
 * Outbound flights have their Itineraries uploaded to the aircraft as it departs in a newly built dev.FlightDescriptor.
 * @stereotype entity
...
public class Itinerary {
  ...
  /**
   *  See dev.Itinerary class description.
   */
  private String from;
