 ...
 * This class registers as an observer of the dev.AircraftManagementDatabase, and is notified whenever any change occurs in that <<model>> element.
...
/**
  * Each Public Information Screen interface has access to the dev.AircraftManagementDatabase.
  * @supplierCardinality 1
  * @clientCardinality 0..*
  * @label accesses/observes
  * @directed*/
  private AircraftManagementDatabase db;
  private String[] columnNames = {"Flight", "Travelling from", "Routing towards", "Final destination", "dev.Gate", "Status"};
