...
//	  return gates[gateNumber].getStatus();
        try {
            ...
            System.out.println("dev.Gate: " + gateNumber + ", does not exist.");
        }
     ...
     * For data collection by the dev.GOC.
     *
     * @return
     */
    ...
    public void allocate(int gateNumber, int mCode) {
        try {
            //dev.Gate allocate handles validation
            gates[gateNumber].allocate(mCode);
            setChanged();
            notifyObservers();
            //If gateNumber is not valid
        } catch (ArrayIndexOutOfBoundsException e) {
            System.out.println("Cannot allocate - dev.Gate: " + gateNumber + ", does not exist.");
        }
    }
...
// Todo : change the method to apply on arraylists.
    ...
    public void docked(int gateNumber) {
        try {
            ...
            System.out.println("Cannot dock - dev.Gate: " + gateNumber + ", does not exist.");
        }
    }
